...
public class FileParsingTest {
    ...
    void parseXlsTest() throws Exception{
        try (InputStream stream = cl.getResourceAsStream("src/test/resource/files/svodnaya_tablica.xlsx")) {
    ...
    void parseCsvTest() throws Exception{
        try (InputStream stream = cl.getResourceAsStream("src/test/resource/files/example.csv")) {
